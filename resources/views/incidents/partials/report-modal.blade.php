    ...
    <div class="bg-white p-6 sm:p-8">
        ...
        <form method="POST" action="{{ route('incidents.store') }}" enctype="multipart/form-data" class="mt-6 grid gap-4 md:grid-cols-2">
            ...
            <div>
                ...
                <input type="text" name="category" value="{{ old('category') }}" class="mt-1 w-full rounded-xl border-slate-300 text-sm shadow-sm focus:border-sky-500 focus:ring-sky-500">
            </div>
            <div>
            ...
            <div class="md:col-span-2">
                ...
                <input type="file" name="proof_photos[]" accept="image/*" multiple class="mt-1 block w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm text-slate-700 shadow-sm">
                <p class="mt-2 text-xs text-slate-500">You can upload up to 10 images. Accepted formats: JPG, PNG, WEBP, GIF. Max size: 5 MB each.</p>
            </div>
