...
Route::middleware(['auth', 'password.change'])->group(function () {
    ...
    Route::redirect('/subdivisions', '/house-management');
    Route::redirect('/subdivisions/{subdivision}', '/house-management/{subdivision}');
    Route::redirect('/subdivisions/{subdivision}/edit', '/house-management/{subdivision}/edit');
    Route::get('/house-management', [SubdivisionController::class, 'index'])->middleware('role:admin,staff,security')->name('subdivisions.index');
    ...
    Route::get('/residents', [ResidentController::class, 'index'])->middleware('role:admin,staff,security')->name('residents.index');
    Route::get('/residents/{resident}', [ResidentController::class, 'show'])->middleware(['role:admin,staff,security', 'subdivision'])->name('residents.show');
